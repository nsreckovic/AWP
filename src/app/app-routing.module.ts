...
const routes: Routes = [
  ...
  { path: 'reservations/:operation', component: ReservationComponent, canActivate: [RouteGuardService] },
  { path: 'reservations/:id/:operation', component: ReservationComponent, canActivate: [RouteGuardService] },
